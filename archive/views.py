    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if form.cleaned_data.get('from_date', False):
                search_result = search_result.filter(create_date__gte=form.cleaned_data['from_date'])
            if form.cleaned_data.get('to_date', False):
                search_result = search_result.filter(create_date__lte=form.cleaned_data['to_date'])
            if form.cleaned_data.get('order_context', False):
                search_result = search_result.filter(Q(ref_order__order_id__icontains=form.cleaned_data['order_context']) |
            ...
            if form.cleaned_data.get('task_context', False):
                search_result = search_result.filter(Q(ref_task__task_id__contains=form.cleaned_data['task_context']) |
            ...
            if form.cleaned_data.get('execution_context', False):
                search_result = search_result.filter(Q(ref_execution__int_executor__description__icontains=form.cleaned_data['execution_context']) |
            ...
            if form.cleaned_data.get('card_context', False):
                search_result = search_result.filter(Q(ref_card__object_full_name__icontains=form.cleaned_data['card_context']) |
            ...
            if search_result is not None:
                search_result = search_result.order_by('ref_order_id', 'ref_task_id', 'ref_execution_id', 'ref_card_id')
